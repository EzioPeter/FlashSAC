...
run_group() {
  ...
  local wm_dir="$BASE_OUT/world_model_seed0_${ntraj}traj_observable"
  local bc_mopo_dir="$BASE_OUT/seed0_${ntraj}traj_bc_mopo_200ep_eval10"
  local pure_mopo_dir="$BASE_OUT/seed0_${ntraj}traj_pure_mopo_200ep_eval10"
