#!/usr/bin/env python3
"""Play a trained Go2 HRLG policy in the native MuJoCo viewer."""
...
DEFAULT_CHECKPOINT = (
    REPO_ROOT / "models/mjp_go2_hrlg/flat_from_scratch/Go2JoystickFlatTerrainHRLG/seed0-latest"
)
...
def _make_set_command_fn(env: Go2JoystickFlatTerrainHRLG):
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Run this many policy steps without opening a viewer.",
    )
    ...
    env = Go2JoystickFlatTerrainHRLG(config=cfg)
    ...
    with mujoco_viewer.launch_passive(model, data) as viewer:
        ...
        while viewer.is_running():
            ...
            if args.follow_camera:
                viewer.cam.lookat[:] = (data.qpos[0], data.qpos[1], 0.35)
            viewer.sync()
